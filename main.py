...
class main():
    ...
    img2 = pygame.image.load("P2/Ninja/Derecha/Run__002.png")
    botonA = recursos.Boton(img2, 258, 450)
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN:
                if cursor1.colliderect(botonZ.rect):
                    ...
                    jugando = True
                if cursor1.colliderect(botonA.rect):
                    director.setBuilder(ConstructorAdaptado())
                    jugando = True
